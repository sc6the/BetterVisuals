...
base {
    archivesName.set("$mod_archives_name.$mod_version")
}
...
tasks {
    ...
    register<Copy>("installMod") {
        group = "bettervisuals"
        description = "Copies the built jar to the .minecraft/mods/1.8.9 folder"
        dependsOn(remapJar)
        from(remapJar.get().archiveFile)
        into(file("${System.getenv("APPDATA")}/.minecraft/mods/1.8.9"))
    }
